...
*/
///////////////////////temp-check////////////////////
void tempCheck(float voltage , TYPE type ) {
  float k = 1; // factor for adjusting voltage
  float thresholdTemp = 60;
  if (type == Aux){
    float res = (10000 * voltage)/(3 -voltage);
    float temperature = (1/(1/298.15+log(res/10)/3976)) - 273.15;
